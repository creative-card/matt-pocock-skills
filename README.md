...
- Ask you which models to dispatch each complexity level to, so `/triage` and `/to-tickets` can label an issue with how much model it needs
...
- **[setup-matt-pocock-skills](./skills/engineering/setup-matt-pocock-skills/SKILL.md)**: Configure this repo for the engineering skills (issue tracker, triage and complexity labels, domain doc layout). Run once per repo before using the other engineering skills.
